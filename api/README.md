...
## Installation.
- First of all, you need to create an database (name it as you like) and an user, then grant all privileges on the new table to the new user.
- Edit app/config/parameters.yml with the database information you used in the above step.
